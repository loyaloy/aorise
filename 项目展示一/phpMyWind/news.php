    ...
    <!-- start 面包屑导航 -->
			...
			<div class="content">
				<div class="row">
					...
					<?php
						$dopage->GetPage("SELECT * FROM `#@__infolist` WHERE (classid=$cid OR parentstr LIKE '%,$cid,%') AND delstate='' and flag like '%c%' AND checkinfo=true ORDER BY orderid ASC",8);
